 ...
 * {@link Pitanje3Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Pitanje3Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Pitanje3Fragment extends Fragment {

    private int val;
    private Animator mCurrentAnimator;
    public int mShortAnimationDuration;

    private TextView odg1, odg2, odg3;
    private Pitanje p;

    private OnFragmentInteractionListener mListener;

    public Pitanje3Fragment() {
        // Required empty public constructor
    }

    public static Pitanje3Fragment newInstance(int pos) {
        Pitanje3Fragment fragment = new Pitanje3Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View result = inflater.inflate(R.layout.fragment_pitanje3, container, false);
        ...
        /*if (val>19) {
            ImageView mImageView = (ImageView) result.findViewById(R.id.imageView);
